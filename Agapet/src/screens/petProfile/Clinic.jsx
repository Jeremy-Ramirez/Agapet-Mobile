                ...
                <View style={style.fondo4}>
                    <View style={style.contenedorCaract}>
                        <View style={style.caracte}>
                            ...
                            <View style={style.iconCaracte5}>
                                <View style={{ flexDirection: "row" }}>
                                    <Text style={{ fontWeight: "bold", fontSize: width * 0.035, margin: '1%' }}> Esterilizado</Text>
                                    <View style={{ justifyContent: 'center' }}>
                                        {
                                ...
                                <Text style={{ fontSize: width * 0.03, margin: '1%' }}> Fecha: {pet.fecha_esterilizado}</Text>
                                <Text style={{ fontSize: width * 0.03, margin: '1%' }}> Lugar: {pet.lugar_esterilizado}</Text>
                            </View>
                            <View style={style.iconCaracte6}>
                                <StatusBar barStyle='dark-content'></StatusBar>
                                <SafeAreaView >
                ...
                <View style={style.fondo6}>
                    {
                        ...
                        clinic.map((vacuna) => {
                            return (
                                vacunasHistorial(vacuna?.vacuna.nombre_vacuna,vacuna?.fecha_vacunacion,vacuna?.lugar_vacunacion,vacuna?.id,vacuna?.descripcion_vacunacion,vacuna?.imagen64)
